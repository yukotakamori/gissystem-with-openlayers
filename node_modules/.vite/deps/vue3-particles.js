...
var zi = class {
  ...
  addPath(e, t, i = false) {
    return !_(this) || !i && this.pathGenerators.has(e) ? false : (this.pathGenerators.set(e, t != null ? t : Se), true);
  }
  destroy() {
    if (!_(this))
      return;
...
var Ii = defineComponent({
  ...
  mounted() {
    nextTick(async () => {
      ...
      }, e = await (this.url ? U.loadJSON(this.id, this.url) : U.load(this.id, (_a = this.options) != null ? _a : {}));
      n(e);
    });
  },
  unmounted() {
