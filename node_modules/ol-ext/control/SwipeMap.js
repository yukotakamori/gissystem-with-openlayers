 ...
 */
var ol_control_SwipeMap = function(options) {
  options = options || {};
 ...
 */
ol_control_SwipeMap.prototype.setMap = function(map) {
  if (this.getMap()) {
 ...
 * @private
 */
ol_control_SwipeMap.prototype._clip = function() {
  if (this.getMap()) {
    var layerDiv = this.getMap().getViewport().querySelector('.ol-layers');
 ...
 * @returns {ol.extent}
 */
ol_control_SwipeMap.prototype.getRectangle = function() {
...
/** @private
*/
ol_control_SwipeMap.prototype.move = function(e) {
  var self = this;
  var l;
